...
import { iModalFormat } from "@/interfaces/pages.interfaces";
...
export default function Dashboard({}) {
  ...
  const { contacts, getContacts, setModalContact, deleteContact } =
    useContactContext();
              ...
              contacts.map((contact) => (
                <ListItem key={contact.id}>
                  ...
                  <Flex align={"center"} pl={"10px"} py={"2px"} gap={"15px"}>
                    <PhoneIcon boxSize={3} />
                    <Text>
                      Celular: {formatPhoneNumber(contact.phone_number)}
                    </Text>
                  </Flex>
                  <Flex align={"center"} pl={"10px"} py={"2px"} gap={"15px"}>
                    <TimeIcon boxSize={3} />
